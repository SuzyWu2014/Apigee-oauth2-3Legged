if (context.flow == "PROXY_REQ_FLOW") {
    ...
    var callbackUrl = "https://osu-test.apigee.net/v1/oauth2/auth-code?response_type=" + responseType + "&scope=" + scope + "&client_id=" + clientId + "&redirect_url=" + redirectUrl;
...
if (context.flow == "PROXY_RESP_FLOW") {
    ...
    context.setVariable("response.header.location", loginUrl);
